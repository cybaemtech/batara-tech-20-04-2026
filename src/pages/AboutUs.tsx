...
const verticals = [
  {
    ...
    suffix: "+",
    icon: Car,
    desc: "OEM, Tier-1 & Tier-2 product design to production",
  },
  {
    ...
    suffix: "+",
    icon: Plane,
    desc: "Space-grade simulation & structural precision design",
  },
  {
    ...
    suffix: "+",
    icon: Activity,
    desc: "Compliance-first medical device engineering",
  },
  {
    ...
    suffix: "+",
    icon: Zap,
    desc: "PCB integration & electromechanical assemblies",
  },
  {
    ...
    suffix: "",
    icon: Package,
    desc: "Mass-market innovation & design execution",
  },
  {
    ...
    suffix: "",
    icon: Truck,
    desc: "Structural, hydraulic & mechanical design",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <motion.div {...fadeUp}>
            ...
            <p className="text-white/75 text-[17px] leading-relaxed max-w-2xl mx-auto mb-5">
            ...
            <p className="text-white/75 text-[17px] leading-relaxed max-w-2xl mx-auto mb-9">
              ...
              <Link
                to="/#services"
                className="text-white font-bold underline underline-offset-4 decoration-primary hover:text-primary transition-colors"
              >
      ...
      <section className="relative z-[1] py-16 md:py-24 px-4 sm:px-8 md:px-16 bg-accent text-primary-foreground overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, hsl(214 72% 42% / 0.12) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <motion.div {...fadeUp} className="text-center mb-14">
            ...
            <p className="text-primary-foreground/50 text-[15px] max-w-lg mx-auto leading-relaxed">
              Built across the most demanding engineering sectors — our pedigree
              is measured in delivered results, not years alone.
            </p>
          </motion.div>
      ...
      {/* Why Batara */}
      <section className="relative z-[1] py-14 md:py-20 px-4 sm:px-8 md:px-16 bg-accent text-primary-foreground overflow-hidden">
        <div
        ...
        <div className="max-w-6xl mx-auto relative">
          <motion.div {...fadeUp} className="text-center mb-12">
            ...
            <p className="text-primary-foreground/70 max-w-xl mx-auto text-[15px] leading-relaxed">
      ...
      <section className="relative z-[1] py-14 md:py-20 px-4 sm:px-8 md:px-16 bg-background text-foreground">
        <div className="max-w-5xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-8 h-0.5 bg-primary" />
