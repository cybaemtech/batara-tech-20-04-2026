...
const ecosystemSteps = [
  ...
  },
  {
    icon: BarChart3,
    label: "Analysis",
    desc: "Simulating the design for total operational integrity via FEA & CFD.",
  },
  {
    icon: Cpu,
    label: "Prototype",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#060c1a]/65 pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#060c1a]/55 via-transparent to-[#060c1a]/75 pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#060c1a]/45 via-transparent to-[#060c1a]/45 pointer-events-none" />
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          <motion.div {...fadeUp}>
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
              ...
              DICTATES FACTORY REALITY
            </h1>
            <p className="text-white/75 max-w-2xl mx-auto text-[15px] leading-relaxed mb-8">
              We eliminate the costly disconnect between the design room and the
              manufacturing floor. We are the engineering brain behind your
              operations. Our designs are so precise that the simulations we
              project are the exact automated realities executed on your factory
              floor.
            </p>
            <div className="inline-block border border-primary/40 bg-primary/15 backdrop-blur-sm rounded-lg px-8 py-4">
              <p className="font-display font-bold text-white text-lg md:text-xl">
                What We Engineer Digitally is Exactly What You Produce
                Physically
              </p>
            </div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto relative">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <p className="text-silver max-w-xl mx-auto text-[15px] leading-relaxed">
              We do not just hand over a CAD file and walk away. We provide a
              complete End-to-End engineering ecosystem — from first concept to
              final production.
            </p>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, hsl(214 72% 20% / 0.9), hsl(214 72% 8% / 0.95))",
                  border: "2px solid hsl(214 72% 50% / 0.4)",
                  boxShadow:
                    "0 0 30px hsl(214 72% 37% / 0.25), 0 0 60px hsl(214 72% 37% / 0.1), inset 0 0 15px hsl(214 72% 40% / 0.1)",
              ...
              >
                ...
                <span className="font-mono text-[8px] font-bold text-[hsl(214_72%_65%)] tracking-[0.15em]">
                  E-2-E
                </span>
              </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="font-mono text-[11px] tracking-[0.2em] uppercase text-primary mb-4">
                ...
                {String(ecosystemSteps.length).padStart(2, "0")}
              </div>
                  ...
                  <div className="flex items-center gap-4 mb-5">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow:
                          "0 0 16px hsl(214 72% 42% / 0.2), inset 0 0 10px hsl(214 72% 55% / 0.08)",
                      }}
                    >
                      {(() => {
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <p className="text-primary-foreground/70 max-w-xl mx-auto text-[15px]">
              We specialize in designing the tools and processes your
              manufacturing floor relies on.
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <p className="text-silver max-w-xl mx-auto text-[15px]">
              Common across all projects — an uncompromising operational
              framework that protects your investment.
            </p>
          </motion.div>
      ...
      <section className="relative z-[1] py-16 md:py-24 px-4 sm:px-8 md:px-16 bg-accent text-primary-foreground overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(hsl(214 72% 55% / 0.06) 1px, transparent 1px), linear-gradient(90deg, hsl(214 72% 55% / 0.06) 1px, transparent 1px)",
        ...
        <div className="max-w-6xl mx-auto relative">
          <motion.div {...fadeUp} className="text-center mb-12">
            ...
            <p className="text-primary-foreground/70 max-w-2xl mx-auto text-[15px] leading-relaxed">
              Our integrated manufacturing approach reduces errors, increases efficiency, and ensures
              every component meets exact specifications — resulting in faster delivery, better
              durability, and unmatched precision.
            </p>
          </motion.div>
      ...
      <section className="relative z-[1] py-14 md:py-20 px-4 sm:px-8 md:px-16">
        <motion.div {...fadeUp} className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-silver text-[15px] mb-8">
            Whether it's a tough tolerance, a complex assembly, or a full
            production challenge — drop your problem statement and our engineers
            will have a plan within 4 hours.
          </p>
