...
const values = [
  {
    label: "Precision",
    desc: "We do not approximate. Every output is validated against spec.",
  },
  {
    label: "Transparency",
    desc: "Clients see what we see — bottlenecks, milestones, and all.",
  },
  {
    label: "Ownership",
    desc: "Everyone holds their deliverable through to its manufactured form.",
  },
  {
    label: "Speed",
    desc: "We move fast without sacrificing the ISO-certified quality bar.",
  },
];
      ...
      <section className="relative z-[1] pt-28 md:pt-36 pb-20 md:pb-28 px-4 sm:px-8 md:px-16 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative w-full max-w-4xl mx-auto text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-[15px] sm:text-[18px] leading-[1.75] text-white/70 max-w-xl mx-auto mb-8 border-l-2 border-[hsl(214_72%_50%/0.7)] pl-4 text-left">
              At Batara Techno Solutions, every engineer's output ends on a shop
              floor. If you want work that matters — that goes from your screen
              into aerospace hardware, automotive bodies, and medical
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-[15px] max-w-xl mx-auto">
              Six reasons why engineers who want real-world impact choose to
              grow with us.
            </p>
          </motion.div>
      ...
      <section className="relative z-[1] py-16 md:py-24 px-4 sm:px-8 md:px-16 bg-background">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-14">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-8 h-0.5 bg-primary" />
              <span className="section-label text-primary">Our Culture</span>
              <div className="w-8 h-0.5 bg-primary" />
            </div>
            <h2 className="section-title text-foreground mb-3">
              WHAT WE STAND FOR
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="text-primary-foreground/65 text-[15px] leading-relaxed mb-8 max-w-xl mx-auto">
              Send your CV, portfolio, and a brief note on what you want to
              build to our careers team. We review every application and respond
